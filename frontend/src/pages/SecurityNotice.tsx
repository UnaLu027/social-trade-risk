...
const sections: Section[] = [
  ...
  {
    heading: '本站保存的資料',
    body: '本站僅保存：註冊電子郵件、經加密雜湊處理的本站專用密碼、使用者建立的股票觀察清單。本站不保存任何金融帳戶資訊、交易紀錄或個人財務資料。',
  },
  {
    heading: '帳戶隔離聲明',
  ...
  {
    heading: '密碼安全建議',
    body: '請僅為本網站建立一組全新的專用密碼，勿重複使用 Google 帳號、學校信箱、銀行、券商或其他服務的密碼。您的本站密碼在伺服器端以加密雜湊方式儲存，本站管理員無法還原您的原始密碼。',
  },
]
